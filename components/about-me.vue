    ...
    <div id="page-menu" class="w-full flex">
      ...
      >
        ...
        <div>
          ...
          >
            <div class="flex col-span-2 hover:text-white hover:cursor-pointer">
              <img
                id="diple"
                src="/pwa/icons/diple.svg"
                alt=""
                :class="{ open: isOpen(folder.title) }"
              />
              <img
                :src="'/pwa/icons/folder' + (index + 1) + '.svg'"
                alt=""
                class="mr-3"
              />
              <p
            ...
            <div v-if="folder.files !== undefined" class="col-span-2">
              ...
              >
                <img src="/pwa/icons/markdown.svg" alt="" class="ml-8 mr-3" />
                <p>{{ key }}</p>
              </div>
            </div>
          </div>
        ...
        <div id="contact-sources" class="hidden lg:flex lg:flex-col my-2">
          ...
          >
            <img :src="'/pwa/icons/' + key + '.svg'" alt="" class="mx-4" />
            <a
              v-html="source"
              href="/"
          ...
          <div :id="'folders-' + section.title" class="hidden">
            ...
            >
              <div class="flex col-span-2">
                <img id="diple" src="/pwa/icons/diple.svg" />
                <img
      ...
      <div id="left" class="w-full flex flex-col border-right">
        ...
        <div class="tab-height w-full hidden lg:flex border-bot items-center">
          <div class="flex items-center border-right h-full">
            ...
            ></p>
            <img src="/pwa/icons/close.svg" alt="" class="mx-3" />
          </div>
        </div>
